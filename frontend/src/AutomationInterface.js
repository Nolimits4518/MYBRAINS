      ...
      {!tradingStatus || tradingStatus.error ? (
        <>
          ...
          <button
            ...
            disabled={loading || (!autoTradingConfig.solana_wallet && !autoTradingConfig.ethereum_wallet && !autoTradingConfig.base_wallet)}
          ...
          >
            {loading ? 'Setting up...' : '🤖 Setup Tri-Chain Automation'}
          </button>
